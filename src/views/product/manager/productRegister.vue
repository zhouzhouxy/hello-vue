  ...
  <div class="info">
    ...
    <div class="mainInfo" >
      <el-row :gutter="24">
        ...
        <el-col :span="4">
          <el-form-item>
            <el-button type="primary" @click="onSubmit('DFile')">提交</el-button>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item label="一级分类" prop="firstKindId">
            <el-select v-model="DFile.firstKindId" placeholder="一级分类" prop="kind">
              <el-option v-for="firstKindId in L1" :label="firstKindId.kindName" :value="firstKindId.id"  :key="firstKindId.id"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="二级分类" prop="secondKindId">
      ...
      <el-row :gutter="24">
        <el-col :span="12"> <el-form-item label="三级分类" prop="thirdKindId">
      ...
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item label="计量单位" >
            <el-input v-model="DFile.personalUnit" placeholder="计量单位"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
<script>
    export default {
      ...
      methods: {
        onSubmit(DFile) {
          const that=this;
          this.$refs[DFile].validate((valid) => {
            if (valid) {
              //提交数据
              this.axios
      ...
      created:function(){
        ...
        this.DFile.registerTime = new Date().Format("yyyy-MM-dd hh:mm:ss");
        //根据父Id查询一级分类
        this.axios
