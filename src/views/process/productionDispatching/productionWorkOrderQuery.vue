  ...
  <div>
    <div v-show="vis">
      ...
      <el-row :gutter="8"  >
        ...
        <el-col :span="14">
          <el-select v-model="condition.manufactureProcedureTag" placeholder="派工单状态">
    ...
    <el-row  v-if="!vis" :gutter="24">
      <el-col :span="18" :offset="3">
        <el-table :data="manufactureList"
                  ...
                  ref="multipleTable"
                  style="width:100%">
          <el-table-column label="派工单编号"
                           width="189x">
            <template slot-scope="scope">
              <router-link :to="{name:'QuerySimpleProduction',params:{id:scope.row.id}}">{{scope.row.manufactureId}}</router-link>
            </template>
          </el-table-column>
          ...
          <el-table-column label="派工单状态">
            <template slot-scope="scope">
              ...
              <span v-if="scope.row.manufactureProcedureTag==2">完成</span>
            </template>
          </el-table-column>
          <el-table-column label="审核状态">
            <template slot-scope="scope">
              <span v-if="scope.row.checkTag==0">等待</span>
              <span v-else-if="scope.row.checkTag==1">通过</span>
