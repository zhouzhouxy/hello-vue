      ...
      <el-table :data="list"
        ...
        <el-table-column label="设计单状态"
          ...
          <template slot-scope="scope">
            <span v-if="scope.row.designModuleTag==0||scope.row.designModuleTag==1">等待</span>
            <span v-if="scope.row.designModuleTag==9">未通过</span>
            <span v-if="scope.row.designModuleTag==3">执行中</span>
            <span v-if="scope.row.designModuleTag==2">完成</span>
          </template>
        </el-table-column>
        <el-table-column label="审核状态"
                         width="180px">
          <template slot-scope="scope">
            <span v-if="scope.row.designModuleTag==0">等待</span>
            <span v-if="scope.row.designModuleTag==9">未通过</span>
            <span v-if="scope.row.designModuleTag==1">等待</span>
            <span v-if="scope.row.designModuleTag==3"></span>
            <span v-if="scope.row.designModuleTag==2">通过</span>
          </template>
        </el-table-column>
        <el-table-column
