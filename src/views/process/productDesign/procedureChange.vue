  ...
  <div>
    ...
    <div v-show="!vis">
      <el-table :data="list"
        ...
        <el-table-column
          label="工时总成本" prop="costPriceSum"   width="180px">

        </el-table-column>
        <el-table-column label="变更">
          <template slot-scope="scope">
            <router-link :to="{name:'ChangeProcedure',params:{id:scope.row.id}}">变更</router-link>
          </template>
        </el-table-column>
...
<script>
  export default {
    ...
    methods:{
      ...
      loadTable(){
        this.axios.post("http://localhost:1217/enxin/m-design-procedure/queryProcedureByCondition",
          this.condition, {
            headers: {
